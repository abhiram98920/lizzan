  ...
  return (
    <div className="map-container">
      <svg viewBox="0 0 500 500" className="map-background">
        ...
        <path
          style={{ fill: 'rgba(212, 175, 55, 0.15)' }} /* Brand gold with opacity */
      ...
      <div className="map-cities">
        <div style={{ '--x': 15, '--y': 67 }} className="map-city">
          <div className="map-city__label">
            <span data-icon="🌴" className="map-city__sign">Kerala HQ</span>
          </div>
        </div>
        <div style={{ '--x': 32, '--y': 32 }} className="map-city">
          <div className="map-city__label">
            <span data-icon="⛰️" className="map-city__sign anim anim-grow">Kashmir</span>
          </div>
        </div>
        <div style={{ '--x': 58, '--y': 83 }} className="map-city">
          <div className="map-city__label">
            <span data-icon="🏖️" className="map-city__sign anim anim-slidein">Maldives</span>
          </div>
        </div>
        <div style={{ '--x': 65, '--y': 22 }} className="map-city">
          <div className="map-city__label">
            <span data-icon="🏛️" className="map-city__sign">Europe</span>
          </div>
        </div>
        <div style={{ '--x': 87, '--y': 58 }} className="map-city">
          <div className="map-city__label">
            <span data-icon="🏙️" className="map-city__sign">Dubai</span>
          </div>
        </div>
      </div>
    </div>
